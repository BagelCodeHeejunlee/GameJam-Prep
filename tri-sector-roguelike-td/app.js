...
const WAVES = [
  ...
  [
    ...
    spawn(2.45, "top", 0.4, "grunt"),
    spawn(2.6, "top", 0.5, "grunt"),
    spawn(2.75, "top", 0.6, "grunt"),
    spawn(3.35, "right", 0.36, "swarm"),
    spawn(3.5, "right", 0.5, "swarm"),
  ...
  [
    ...
    spawn(3.5, "top", 0.25, "swarm"),
    spawn(3.65, "top", 0.5, "swarm"),
    spawn(4.0, "top", 0.75, "grunt"),
  ...
  [
    ...
    spawn(3.25, "left", 0.42, "grunt"),
    spawn(3.4, "right", 0.58, "grunt"),
    spawn(4.05, "bottom", 0.32, "swarm"),
    spawn(4.18, "bottom", 0.44, "swarm"),
    spawn(4.31, "bottom", 0.56, "swarm"),
    spawn(4.44, "bottom", 0.68, "swarm"),
    spawn(5.0, "top", 0.5, "swarm"),
    spawn(5.15, "top", 0.62, "swarm"),
  ],
  [
    ...
    spawn(3.25, "top", 0.25, "grunt"),
    spawn(3.45, "top", 0.75, "grunt"),
    spawn(4.1, "left", 0.28, "tank"),
    spawn(4.3, "right", 0.72, "tank"),
    spawn(5.15, "bottom", 0.36, "swarm"),
    spawn(5.28, "bottom", 0.5, "swarm"),
    spawn(5.41, "bottom", 0.64, "swarm"),
